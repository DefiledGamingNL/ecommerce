                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Afbeelding</th>
                            ...
                            <tbody>
                            <tr v-for="post in posts" :key="post.id" class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <td class="px-4 py-2">
                                    <img v-if="post.image" :src="`/storage/${post.image}`" alt="post image" class="w-10 h-10 rounded-full">
                                    <img v-else src="https://placehold.co/10x10" alt="placeholder image" class="w-10 h-10 rounded-full">
                                </td>
                                ...
                                <td class="px-4 py-2">
                                    <p class="flex-col text-primary-900 font-medium rounded dark:bg-primary-900 dark:text-primary-500">{{ post.slug }}</p>
                                </td>
          ...
          <span class="font-semibold text-gray-900 dark:text-white">{{ pagination.lastPage }}</span>
                        ...
                        <ul class="inline-flex items-stretch -space-x-px">
                            ...
                            <li>
                                ...
                                <a v-if="pagination.nextPage" class="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" :href="pagination.nextPage">
                                    Volgende
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
